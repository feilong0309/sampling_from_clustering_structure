...
if __name__ == "__main__":
    ...
    for i in xrange(args.start, args.end + 1):
        if args.mu == 0.95:
            ...
            shutil.copy(args.bench_directory_stem + 'friendster/network_v1_subgraph_speed_up.dat', args.out_directory_stem + 'network_v' + str(i) + '.dat')
            shutil.copy(args.bench_directory_stem + 'friendster/community_v1.dat', args.out_directory_stem + 'community_v' + str(i) + '.dat')
            #com-friendster.top5000.cmty.txt
        elif args.mu == 0.5:
            shutil.copy(args.bench_directory_stem + 'dblp/network_v1_subgraph_speed_up.dat', args.out_directory_stem + 'network_v' + str(i) + '.dat')
            shutil.copy(args.bench_directory_stem + 'dblp/community_v1.dat', args.out_directory_stem + 'community_v' + str(i) + '.dat')
            #com-dblp.top5000.cmty.txt
        
        elif args.mu == 0.4:
            shutil.copy(args.bench_directory_stem + 'amazon/network_v1_subgraph_speed_up.dat', args.out_directory_stem + 'network_v' + str(i) + '.dat')
            shutil.copy(args.bench_directory_stem + 'amazon/community_v1.dat', args.out_directory_stem + 'community_v' + str(i) + '.dat')
            ...
            shutil.copy(args.bench_directory_stem + 'youtube/network_v1_subgraph_speed_up.dat', args.out_directory_stem + 'network_v' + str(i) + '.dat')
            shutil.copy(args.bench_directory_stem + 'youtube/community_v1.dat', args.out_directory_stem + 'community_v' + str(i) + '.dat')                #com-youtube.top5000.cmty.txt        
        elif args.mu == 0.1: 
            shutil.copy(args.bench_directory_stem + 'orkut/network_v1_subgraph_speed_up.dat', args.out_directory_stem + 'network_v' + str(i) + '.dat')
            shutil.copy(args.bench_directory_stem + 'orkut/community_v1.dat', args.out_directory_stem + 'community_v' + str(i) + '.dat')
        else:
...
#        Statistics of the graphs. if args.mu >= 0.1 and args.mu <= 0.6:
        if 1:
...
#            print('number of multiple edges: %d' % (num_edges_multi))            
            ...
            num_edges_org = nx.number_of_edges(G)
            print('number of original edges: %d' % (num_edges_org))  
